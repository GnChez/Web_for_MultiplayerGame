    ...
    <v-list>
      <v-list-item>
        <v-list-item-content style="display: grid; grid-template-columns: 1fr 2fr 2fr 1fr;">
          <v-list-item-title style="padding-right: 40px;">Position</v-list-item-title>
          <v-list-item-title style="padding-right: 40px;">Player 1</v-list-item-title>
          <v-list-item-title style="padding-right: 40px;">Player 2</v-list-item-title>
